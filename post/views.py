...
from .serializers import PostSerializer, PostLikeSerializer, CommentSerializer, CommeCommentLikentLikeSerializer
...
class CommentLikeListView(generics.ListAPIView):
    serializer_class = CommeCommentLikentLikeSerializer()
    permission_classes = [AllowAny, ]
...
class CommentLikeAPiView(APIView):
    def post(self, request, pk):
        try:
            ...
            serializer = CommentSerializer(comment_like)
            data = {
                "success": True,
